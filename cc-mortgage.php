...
function cc_mortgage_init ()
{
    return register_widget('cc_mortgage');
}
add_action ('widgets_init', 'cc_mortgage_init');


// load widget style and javascript files
function cc_mortgage_scripts() {
	wp_register_style( 'cc-mortgage', plugins_url('/cc-mortgage.css',__FILE__), NULL, '1.1.0'); 
	wp_enqueue_style( 'cc-mortgage' );
    wp_enqueue_script( 'cc-mortgage', plugins_url('/cc-mortgage.js',__FILE__), array('jquery'), '1.1.0', true );
}
